...
export const Stake = () => {
  ...
  const handlePercentageClickWithdraw = (percentage) => {
    if (unlockedBalance) {
      ...
      setInputValueWithdraw((balance * (percentage / 100)).toFixed(18));
    }
  };
        ...
        <main className={style.stake_parent + " d-flex justify-content-center"}>
            <div className={style.stake}>
                ...
                <div className={style.top + " mt-4 d-flex justify-content-between align-items-center"}>
                    ...
                    <Link to="/stake-withdraw" className='btn-fill-dark py-3 px-4'>Withdraw</Link>
                </div>
                ...
                <div className={style.inputdiv + " mt-3"}>
                    ...
                    <div className='mt-2 d-flex align-items-center justify-content-between'>
                        ...
                        {/* <p className='mb-0' style={{fontWeight:"500"}}><span className='opacity-50'>Balance</span>  {parseFloat?.(mntBalance?.formatted)
