...
// File contracts/PTNTreasuryFund.sol

pragma solidity 0.8.4;

contract BRAVEATreasuryFund is Fund {
    uint256 public constant ALLOCATION = 50_000_000 ether; // 10%
    uint256 public constant VESTING_DURATION = 1 * 24 * 3600; // 3 month
    uint256 public constant VESTING_START = 1702111311;
