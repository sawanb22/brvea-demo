...
// File contracts/treasury/PotionDaoTreasury.sol

pragma solidity 0.8.4;

/*  PotionDaoTreasury.sol ============================================
    The contract is to store the reserve of PotionDao Protocol
...
==================================================================== */
contract BraveaDaoTreasury is Ownable {
    using SafeERC20 for IERC20;
    using Address for address;

    mapping(address => bool) public strategies;
    address[] public strategiesArray;
    IPotionDaoStaking public staking;

    constructor(IPotionDaoStaking _staking, address initialOwner) {
        staking = _staking;
    ...
    /// @notice Return ERC-20 balance of PotionDaoTreasury
    /// @param _token Address of the ERC-20 token
    /// @return Balance of the PotionDaoTreasury
    ...
    function requestFund(address _token, uint256 _amount) external {
        require(strategies[msg.sender], "PotionDaoTreasury::requestFund: Only strategies can request fund");
        require(_amount <= balanceOf(_token), "PotionDaoTreasury::requestFund: Request more fund than balance");
    ...
    function addStrategy(address _strategy) external onlyOwner {
        require(_strategy != address(0), "PotionDaoTreasury::addStrategy: invalid address");
        require(!strategies[_strategy], "PotionDaoTreasury::addStrategy: strategy was previously added");
    ...
    function removeStrategy(address _strategy) external onlyOwner {
        require(strategies[_strategy], "PotionDaoTreasury::removeStrategy: strategy not found");
    ...
    function allocateFee(address _token, uint256 _amount) external onlyOwner {
        require(address(staking) != address(0), "PotionDaoTreasury::allocateFee:Fee distributor not set");
        require(_amount > 0, "PotionDaoTreasury::allocateFee: invalid amount");
