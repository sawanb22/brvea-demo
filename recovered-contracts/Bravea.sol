...
contract Bravea is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Bravea", unicode"BRVEA") {

        address newOwner = msg.sender;

        IDexRouter _dexRouter = IDexRouter(0x1689E7B1F10000AE47eBfE339a4f69dECd19F602);
