/**
 *Submitted for verification at testnet.bscscan.com on 2024-12-30
*/

/**
 *Submitted for verification at testnet.bscscan.com on 2024-09-30
*/
...
library WethUtils {
    ...
    IERC20 public constant POTION = IERC20(0x0BE5668B61dB6eB4Bb9d5396124C505557FC9CCd); //PTN token
...
contract BraveaDaoStaking is ReentrancyGuard, Ownable {
    ...
    uint256 public  rewardsDuration = 43200; // 4 days

    // Duration of lock/earned penalty period
    uint256 public  lockDuration = 900; // 2 weeks
    ...
    function updateLockDuration(uint _newtime) external onlyOwner {
        lockDuration = _newtime;
    }

    function updateRewardDuration(uint _newtime) external onlyOwner {
        rewardsDuration = _newtime;
    }
