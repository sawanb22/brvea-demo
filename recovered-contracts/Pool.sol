...
library WethUtils {
    ...
    IWETH public constant weth = IWETH(0x4200000000000000000000000000000000000006); //WETH
    IERC20 public constant WETH = IERC20(0x4200000000000000000000000000000000000006); //WETH  token
...
contract Pool is Ownable, ReentrancyGuard {
    ...
    uint256 public refreshCooldown = 1800; // = 1 hour
    ...
    uint256 public priceTarget = 1e18; // = 1; 1 XToken pegged to the value of 1 WETH
    uint256 public priceBand = 4e15; // = 0.004; CR will be adjusted if XToken > 1.004 WETH or XToken < 0.996 WETH
        ...
        )
    {
        ...
        if (collateralRatio < COLLATERAL_RATIO_MAX && yToken.tradingActive()) {
    ...
    function collect() external nonReentrant {
        ...
        if (_sendEth) {
            WethUtils.WETH.safeTransfer(_sender, _ethAmount);
        }
    }
